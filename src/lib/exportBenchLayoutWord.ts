...
export const exportBenchLayoutWordDoc = async ({
    ...
    const headerParagraphs = [
        ...
        new Paragraph({
            ...
            children: [
                new TextRun({
                    text: "COLLEGE FOR ENGINEERING AND TECHNOLOGY",
                    size: 28, // 14pt
                }),
            ],
        }),
        ...
        new Paragraph({
            ...
            children: [
                new TextRun({
                    text: "ACADEMIC YEAR 2025-2026 (ODD SEMESTER)",
                    size: 22, // 11pt
                }),
            ],
        }),
        new Paragraph({
            ...
            children: [
                new TextRun({
                    text: "INTERNAL ASSESSMENT TEST – II (Except I Year)",
                    size: 22,
                }),
            ],
        }),
                ...
                properties: {
                    page: {
                        size: {
                            ...
                            width: 16838, // A3 width in twips (approx 297mm * 56.7) - standard A3 landscape
                            height: 11906, // A3 height
                        },
                        margin: {
                            top: 720, // 0.5 inch
                            right: 720,
